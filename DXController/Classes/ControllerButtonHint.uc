...
// icon + label hints.
//
// Owns the logical-id -> texture map for the DXController textures
...
const ICON_SRC  = 64.0;   // native edge length of the DXController button
...
{
    if (id == "a")          return Texture'DXController.a';
    if (id == "b")          return Texture'DXController.b';
    if (id == "x")          return Texture'DXController.x';
    if (id == "y")          return Texture'DXController.y';
    if (id == "back")       return Texture'DXController.back';
    if (id == "share")      return Texture'DXController.share';
    if (id == "start")      return Texture'DXController.start';
    if (id == "dpad")       return Texture'DXController.dpad';
    if (id == "dpad_up")    return Texture'DXController.dpad_up';
    if (id == "dpad_down")  return Texture'DXController.dpad_down';
    if (id == "dpad_left")  return Texture'DXController.dpad_left';
    if (id == "dpad_right") return Texture'DXController.dpad_right';
    if (id == "lb")         return Texture'DXController.lb';
    if (id == "ls")         return Texture'DXController.ls';
    if (id == "lt")         return Texture'DXController.lt';
    if (id == "rb")         return Texture'DXController.rb';
    if (id == "rs")         return Texture'DXController.rs';
    if (id == "rt")         return Texture'DXController.rt';
    return None;
}
